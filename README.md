# @plurnk/plurnk-mimetypes-text-datalog

text/x-datalog mimetype handler for plurnk-service. ANTLR-backed extraction using grammars-v4's `datalog` grammar.
...
```bash
npm install @plurnk/plurnk-mimetypes-text-datalog
```
